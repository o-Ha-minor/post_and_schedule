...
趣味の音楽活動や個人プロジェクトの中で生まれた「スケジュール・話題・タスクの分散管理」を  
ひとつのアプリでまとめることを目的に開発しました。
...
## 制作の目的
- チームでの予定・話題・タスクを統合管理できるWebアプリを構築
- RailsとVueを分離構成で連携し、SPAとしてUX向上を実現
- ChatGPT APIによるAI感情分析と、Rails側での統合を経験
...
- [ ] AIキャラのカスタマイズ機能拡張（AIキャラにより、方向の違うコメントを生成）
